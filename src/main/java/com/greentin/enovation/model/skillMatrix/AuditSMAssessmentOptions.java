 ...
 * @desc this Entity used for auditing SMAssessmentOptions entity records of (delete, update)
 * @comments
 */

@Entity
@Table(name = "audit_sm_assessment_options")
public class AuditSMAssessmentOptions {
