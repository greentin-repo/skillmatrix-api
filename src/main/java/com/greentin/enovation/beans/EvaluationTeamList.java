...
public class EvaluationTeamList {

	private String evalProfilePic;
	...
	private String summaryRejectionEvaluation;
	...
	public String getSummaryRejectionEvaluation() {
		return summaryRejectionEvaluation;
	}
	public void setSummaryRejectionEvaluation(String summaryRejectionEvaluation) {
		this.summaryRejectionEvaluation = summaryRejectionEvaluation;
	}
	...
	public String getEvalProfilePic() {
		if(evalProfilePic==null) {
			return evalProfilePic;	
		}else {
			return	EnovationConfig.buddyConfig.get("ProfilePicPathUrl")+evalProfilePic;
		}

	}
	public void setEvalProfilePic(String evalProfilePic) {
		this.evalProfilePic = evalProfilePic;
	}
